...
demand = np.random.normal(10,5,size=n_Warehouse)

# Plant capacity in thousands of units
capacity = np.random.normal(50,0,size=n_Plant)

# Fixed costs for each plant
fixedCosts = np.random.normal(2000,5,size=n_Plant)

# Transportation costs per thousand units
transCosts = np.random.normal(100,5,size=(n_Warehouse,n_Plant))
